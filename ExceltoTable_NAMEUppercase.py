...
#create a list and interate through the list. calculate the field and rename the table. 
...
for table in tables:
    ...
    arcpy.Rename_management(table,'Housing{}'.format(newName))
    print('Table was renamed')
