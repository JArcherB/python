...
#arcpy.env.workspace = r"C:\Users\jaburton\Documents\ArcGIS\Projects\VectorBasemap.gdb"
ENV= arcpy.env
...
dateTimeStamp = time.strftime('%Y%m%d%h')
...
## the guts of writing to a log file
#
#logoutput = open(r'J:\Test\Test_Log.txt','w+') # this is the output text file
#logoutput.write("Began at " + dateTimeStamp + "\n")
#logoutput.write("-------------------------------------" + "\n")
#logoutput.write('Add text line like this...'+'\n')
#logoutput.write('And another like this...'+'\n')
#logoutput.write("-------------------------------------" + "\n")
...
def sendEmail(subject, emailMessage):
    ...
    RECIPIENTS = ["jborgione@slco.org", 'jaburton@slco.org']
    SENDER = 'jaburton@slco.org'
...
#    
#    msg = MIMEMultipart()
#    msg['From'] = "jaburton@slco.org"
#    msg['To'] = "Vector Tile Beta User" 
#    msg['Date'] = formatdate(localtime=True)
#    msg['Subject'] = "Success: Vector Tile Update Complete" 
#    msg.attach(MIMEText("Vector Tile Package created and published to ArcGIS Online. "))
#    
#    f = r"‪J:\Test\Test_Log.txt"
...
#    server.sendmail("jaburton@slco.org", ["jborgione@slco.org", "mgduncan@slco.org" ], msg.as_string())
#    server.quit()
...
# Variables
user= 'SLCoVector' # ArcGIS Online Username It must be the owner of the tile package item and vector tile service
pw = 'bw#r%X1%fBr2' # ArcGIS Online Password?')
VectorCacheProject = r"‪C:\Users\jaburton\Documents\ArcGIS\Projects\VectorBasemap\VectorBasemap.aprx" # This is the project used to create the Vector Tile Package

# Cache 1 Variables
Cache1_ProMapName = "VectorTile" # name of the map in the ArcGIS Pro Project
Cache1_tpk =  r"C:\\VectorCacheProject\\VectorCaches\\Packages\\Cache1VectorCache.vtpk" # location of VTPK
Cache1_MinCacheScale = 295828764 
Cache1_MaxCacheScale = 35
Cache1_Index = r"C:\Users\jaburton\Documents\ArcGIS\Projects\VectorBasemap\VectorBasemap.gdb\VectorTileIndex1" # Vector Cache Index Feature class
Cache1_Summary = "Salt Lake County vector tile for basemap"
Cache1_Tags = "Salt Lake, County, Cache1"
Cache1_inItemID= 'fa3fae66dfb046dab29eaa085b019f14'# Item ID of the uploaded VTPK
Cache1_layerName ='VectorTile_1'# Service Name of the vector tile service to overwrite
Cache1_extent = '{"xmin":-114.24,"ymin":36.97,"xmax":-108.86,"ymax":42.02,"spatialReference":{"wkid":102100}}' #'extent'# example'{"xmin":-1.84761407196E7,"ymin":1995253.5241999999,"xmax":-7185123.9953000005,"ymax":1.1525580625400003E7,"spatialReference":{"wkid":102100}}'
Cache1_lods = '6-23' #enter levels in format outlined http://resources.arcgis.com/en/help/arcgis-rest-api/index.html#/Update_Tiles/02r30000022v000000/
